...
@section('content_header')
    ...
    <h5 class="text-white font-weight-bold mt-2">HALAMAN DATA USER</h5>
    <small>Halaman ini merupakan halaman yang digunakan untuk melakukan management Data User.</small>
@endsection
